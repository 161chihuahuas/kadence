  ...
  describe('@method exec', function() {
    ...
    it('should update the contact info', function(done) {
      ...
      strategy.exec(node, (err) => {
        ...
        expect(node.contact.hostname).to.equal('nodeid.tun.tacticalchihuahua.lol');
