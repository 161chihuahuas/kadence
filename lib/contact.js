...
class ContactList {
   ...
   * @param {Array<module:kadence/contacts~Contact>} [contacts] - List to initialize with
   */
  ...
  /**
   * @property {module:kadence/contacts~Contact} closest - The contact closest to the reference key
   */
  get closest() {
  ...
  /**
   * @property {module:kadence/contacts~Contact[]} active - Contacts in the list that are active
   */
  get active() {
  ...
  /**
   * @property {module:kadence/contacts~Contact[]} uncontacted - Contacts in the list that have not been
   * contacted
   */
  get uncontacted() {
   ...
   * @param {module:kadence/contacts~Contact[]} contacts - Contacts to add to the list
   * @returns {module:kadence/contacts~Contact[]} added - Contacts added to the list
   */
  add(contacts) {
   ...
   * @param {module:kadence/contacts~Contact} contact - Mark as contacted
   * @returns {undefined}
   */
  contacted(contact) {
   ...
   * @param {module:kadence/contacts~Contact} contact - Mark as responded
   * @returns {undefined}
   */
  responded(contact) {
