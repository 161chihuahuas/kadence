...
class Bucket extends Map {
  ...
  /**
   * @property {Array<string, module:kadence/contacts~Contact>} head - The contact at the bucket head
   */
  get head() {
  ...
  /**
   * @property {Array<string, module:kadence/contacts~Contact>} tail - The contact at the bucket tail
   */
  get tail() {
   ...
   * @param {module:kadence/contacts~Contact} contact - The address information for the contact
   ...
   * @returns {Array<string, module:kadence/contacts~Contact>}
   */
