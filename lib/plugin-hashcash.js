...
class HashCashPlugin {
   ...
   * @returns {module:dusk/hashcash~HashCashPlugin~stamp}
   */
  static parse(header) {
  ...
  /**
   * @typedef module:dusk/hashcash~HashCashPlugin~stamp
...
/**
 * Registers the {@link module:dusk/hashcash~HashCashPlugin} with an
 * {@link AbstractNode}
 * @param {object} [options]
 * @param {string[]} [options.methods=[]] - RPC methods to enforce hashcash
 * @param {number} [options.difficulty=8] - Leading zero bits in stamp
