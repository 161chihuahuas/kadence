...
class Protocol {
   ...
   * 
   *
   * @event module:kadence/protocol~Protocol#storage_get
   */
 
  /**
   * 
   *
   * @event module:kadence/protocol~Protocol#storage_put
   */ 

  /**
   * @constructor
   * @param {module:kadence/router~Router} router - Routing table to use
   ...
   * @param {module:kadence/contacts~Contact} contact - The peer who originated this RPC
   * @param {module:kadence/protocol~HandlerResponse} respond - Callback function for responding to RPC
   */
   ...
   * @fires module:kadence/protocol~Protocol#storage_put
   * @param {string} key - 160 bit ID to address this blob by
   * @param {module:kadence/node~StoredItem} item - Blob and metadata to store
   * @param {module:kadence/contacts~Contact} contact - The peer who originated this RPC
   * @param {module:kadence/protocol~HandlerResponse} respond - Callback function for responding to RPC
   */
   ...
   * @fires module:kadence/protocol~Protocol#storage_get
   * @param {string} key - 160 bit ID to search for
   * @param {module:kadence/contacts~Contact} contact - The peer who originated this RPC
   * @param {module:kadence/protocol~HandlerResponse} respond - Callback function for responding to RPC
   */
