Getting started with building distributed systems with Dusk is simple, but 
...
Dusk: using the complete reference implementation as a daemon and 
...
> Note that this guide assumes you already have Dusk installed. If you have 
> not installed Dusk, follow our guide for {@tutorial install} and come 
...
Not all use-cases require the exact properties of a "proper" Dusk network. 
Because of this, Dusk exposes it's core library as a complete framework for 
building distributed systems. This guide will demonstrate how to use the 
Dusk framework to invent new distributed protocols.

Start by following the guide for {@tutorial install} and install Dusk 
...
Then install Dusk and save the dependency to your `package.json` file.

```
$ npm install @deadcanaries/dusk --save
```
...
const node = new dusk.KademliaNode({
  identity: dusk.utils.getRandomKeyBuffer(),
  transport: new dusk.UDPTransport(),
...
* {@tutorial messengers}
* [Examples](https://github.com/tacticalchihuahua/dusk/tree/main/example)
* [Reference Implementation](https://github.com/tacticalchihuahua/dusk/blob/main/bin/dusk.js)

> **Note!** If you are using Dusk to build a distributed network from scratch
> the best place to start is the [reference implementation](https://gitlab.com/dusk/dusk/blob/master/bin/dusk.js).
> This provides a complete working Dusk network that leverages all the 
...
Dusk "proper" describes a Kademlia DHT with several notable protocol 
...
* {@link module:dusk/rolodex}
* {@link module:dusk/traverse}
* {@link module:dusk/onion}
* {@link module:dusk/hibernate}

Together these plugins combined with the base implementation of the Kademlia 
DHT form the Dusk protocol and a complete standalone program for running a 
configurable Dusk node. If you installed Dusk using the `-g` or 
`--global` flag, you now have access to the `dusk` command line program. 
This program handles everything you need to interact with a Dusk network 
from any programming language.

#### Identity Generation

Dusk mitigates eclipse attacks (a form of a sybil attack) by requiring node 
identities to act as a proof-of-work solution. This means that Dusk expects 
...
{@link module:dusk/constants~IDENTITY_DIFFICULTY}. This prevents adversaries 
...
The first time you run `dusk`, it will automatically begin "mining" a valid 
...
{"name":"dusk","hostname":"librem","pid":23409,"level":40,"msg":"identity derivation not yet solved - 0 is invalid","time":"2018-03-16T15:28:05.357Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"solving identity derivation index with 1 solver processes, this can take a while","time":"2018-03-16T15:28:05.357Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"forking derivation process 0","time":"2018-03-16T15:28:05.377Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"solved identity derivation index 11 in 882ms","time":"2018-03-16T15:28:06.239Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"initializing dusk","time":"2018-03-16T15:28:06.244Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"validating solutions in wallet, this can take some time","time":"2018-03-16T15:28:06.257Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"node listening on local port 5274 and exposed at https://127.0.0.1:5274","time":"2018-03-16T15:28:06.262Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"binding controller to path /home/bookchin/.config/dusk/dusk.sock","time":"2018-03-16T15:28:06.262Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"forking solver process 0","time":"2018-03-16T15:28:06.263Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"no bootstrap seeds provided and no known profiles","time":"2018-03-16T15:28:06.269Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"running in seed mode (waiting for connections)","time":"2018-03-16T15:28:06.269Z","v":0}
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"derivation solver 0 exited normally","time":"2018-03-16T15:28:06.272Z","v":0}
```
...
Once your Dusk node has generated a valid identity, you'll begin seeing log 
messages similar to the following:

```
{"name":"dusk","hostname":"librem","pid":23409,"level":30,"msg":"solver 0 found solution in 4 attempts (226ms)","time":"2018-03-16T15:28:06.804Z","v":0}
```

This is part of Dusk's permission protocol for storing entries in the DHT. 
In a basic Kademlia network, entries can be stored and overwritten by any 
party. Dusk employs a proof-of-work system that requires nodes attempting 
to store an entry provide a "solution". Solutions are "mined" by a process 
similar to how Dusk identities are generated, but instead are derived from 
...
The Dusk daemon exposes a control interface to other applications by default 
over a UNIX domain socket located at `$HOME/.config/dusk/dusk.sock`, but 
...
{"name":"dusk","hostname":"librem","pid":24893,"level":30,"msg":"initializing dusk","time":"2018-03-16T16:43:04.503Z","v":0}
{"name":"dusk","hostname":"librem","pid":24893,"level":30,"msg":"validating solutions in wallet, this can take some time","time":"2018-03-16T16:43:04.519Z","v":0}
{"name":"dusk","hostname":"librem","pid":24893,"level":30,"msg":"node listening on local port 5274 and exposed at https://127.0.0.1:5274","time":"2018-03-16T16:43:04.576Z","v":0}
{"name":"dusk","hostname":"librem","pid":24893,"level":30,"msg":"binding controller to port 5275","time":"2018-03-16T16:43:04.577Z","v":0}
{"name":"dusk","hostname":"librem","pid":24893,"level":30,"msg":"there are no solver processes running","time":"2018-03-16T16:43:04.577Z","v":0}
{"name":"dusk","hostname":"librem","pid":24893,"level":30,"msg":"no bootstrap seeds provided and no known profiles","time":"2018-03-16T16:43:04.578Z","v":0}
{"name":"dusk","hostname":"librem","pid":24893,"level":30,"msg":"running in seed mode (waiting for connections)","time":"2018-03-16T16:43:04.578Z","v":0}
```

When starting Dusk with `ControlPortEnabled=1`, you'll notice a log message 
